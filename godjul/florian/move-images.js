...
// Add additional festive text elements
const extraTexts = [
  "Du kommer aldrig få tråkigt i Florians sällskap!!!",
  "Hur mycket vet FLorian egentligen??? Det vet ingen. Inte ens han själv. Men det är uppenbarligen ganska mycket.",
  "Är han inte ganska snygg också eller"
];
